...
function load_twitter_profile(responseJson) {
    ...
    `<img class="banner" src=${profile['profile_banner_url']} alt="Twitter Banner">
    <div class="profile-details">
        <img class="profile-pic" src=${profile['profile_image_url']} alt="Profile Picture">
        <div class="user-ctr">
            <p class="user">${profile['name']}</p>
            <p class="username">${profile['screen_name']}</p>
        </div>
        <p class="description">${profile['description']}</p>
        <div class="location-url-join">
            <span class="icon-ctr">
            ...
            <a class="icon-ctr">
                ...
                <span>priyaps2000.github.io</span>    
            </a>
            <span class="icon-ctr">
                <svg viewBox="0 0 24 24" aria-hidden="true" class="icon">
                    <g>
